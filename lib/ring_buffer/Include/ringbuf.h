#ifndef RING_BUFFER_INCLUDE_RINGBUF
#define RING_BUFFER_INCLUDE_RINGBUF
 ...
 * pointer, into a contiguous memory area dst, without advancing the
 * tail pointer. Unlike ringbuf_memcpy_from, this operation is
 * non-destructive: the copied bytes remain available in the ring
 * buffer after the call, and the ring buffer's free byte count is
 * unchanged.
 *
...
#endif /* RING_BUFFER_INCLUDE_RINGBUF */
